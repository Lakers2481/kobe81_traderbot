...
# Suppress pandas-ta warnings during import
...
class TechnicalFeatures:
    ...
    def _validate_pandas_ta(self) -> None:
        """Check that pandas-ta is available."""
        if not PANDAS_TA_AVAILABLE:
            jlog("pandas_ta_not_available", level="WARNING",
                 message="pandas-ta not installed, using fallback indicators")
